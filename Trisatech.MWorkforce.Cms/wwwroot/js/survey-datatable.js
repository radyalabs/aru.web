jQuery(document).ready(function () {
    var oTable = $('#table-list').DataTable({
        ...
        "aoColumns": [
            ...
            //{
            //    'mData': function (s) {
            //        return '<a class="btn btn-sm btn-block green" href="' + s.urlDetail + '">Detail</a> <a class="btn btn-sm btn-block blue" href="' + s.urlEdit + '">Edit</a> <a class="btn btn-sm btn-block red btn-delete" data-toggle="modal" href="#confirmDelete" data-id="' + s.survey_id + '">Delete</a>';
            //    }, 'bSortable': false, sClass: 'text-center'
            //}
        ],
